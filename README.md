...
```bash
ANDB_PROJECT=trl-vmpo TRL_EXPERIMENTAL_SILENCE=1 python examples/scripts/vmpo.py  --dataset_name trl-internal-testing/descriptiveness-sentiment-trl-style  --dataset_train_split descriptiveness  --learning_rate 5e-6  --num_vmpo_epochs 1  --num_mini_batches 1  --output_dir models/minimal/vmpo9  --per_device_train_batch_size 64  --gradient_accumulation_steps 1  --total_episodes 10000  --model_name_or_path EleutherAI/pythia-70m-deduped  --sft_model_path EleutherAI/pythia-70m-deduped  --reward_model_path EleutherAI/pythia-1b-deduped  --missing_eos_penalty 1.0 --report_to wandb --resume_from_checkpoint false --lr_scheduler_type constant```
