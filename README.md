...
```bash
WANDB_PROJECT=trl-vmpppo TRL_EXPERIMENTAL_SILENCE=1 python examples/scripts/token_weighted_vmpo/token_weighted_vmpo.py  --dataset_name trl-internal-testing/descriptiveness-sentiment-trl-style  --dataset_train_split descriptiveness  --learning_rate 5e-6  --num_mini_batches 1  --output_dir models/minimal/vmpppo9  --per_device_train_batch_size 64  --gradient_accumulation_steps 1  --total_episodes 10000  --model_name_or_path EleutherAI/pythia-70m-deduped  --sft_model_path EleutherAI/pythia-70m-deduped  --reward_model_path EleutherAI/pythia-1b-deduped  --missing_eos_penalty 1.0 --report_to wandb --resume_from_checkpoint false --lr_scheduler_type constant

WANDB_PROJECT=trl-vmpppo TRL_EXPERIMENTAL_SILENCE=1 python examples/scripts/token_weighted_vmpo/token_weighted_vmpo.py  --dataset_name trl-internal-testing/descriptiveness-sentiment-trl-style  --dataset_train_split descriptiveness  --learning_rate 5e-6  --num_mini_batches 1  --output_dir models/minimal/vmpppo9  --per_device_train_batch_size 64  --gradient_accumulation_steps 1  --total_episodes 10000  --model_name_or_path EleutherAI/pythia-70m-deduped  --sft_model_path EleutherAI/pythia-160m-deduped  --reward_model_path EleutherAI/pythia-1b-deduped  --missing_eos_penalty 1.0 --report_to wandb --resume_from_checkpoint false --lr_scheduler_type constant

WANDB_PROJECT=trl-vmpppo TRL_EXPERIMENTAL_SILENCE=1 python examples/scripts/token_weighted_vmpo/token_weighted_vmpo.py  --dataset_name trl-internal-testing/descriptiveness-sentiment-trl-style  --dataset_train_split descriptiveness  --learning_rate 5e-6  --num_mini_batches 1  --output_dir models/minimal/vmpppo9  --per_device_train_batch_size 64  --gradient_accumulation_steps 1  --total_episodes 10000  --model_name_or_path EleutherAI/pythia-1b-deduped  --sft_model_path EleutherAI/pythia-1b-deduped  --reward_model_path EleutherAI/pythia-1b-deduped  --missing_eos_penalty 1.0 --report_to wandb --resume_from_checkpoint false --lr_scheduler_type constant
```
