...
# DAR on UltraFeedback (prompt-only, online generation, k=2).
# Uses a reward model to score completions.
#
# Overridable env vars:
#   CUDA_VISIBLE_DEVICES  (default: 0,1,2,3)
#   NUM_PROCESSES         (default: 4)
#   OUTPUT_DIR            (default: Qwen2-0.5B-DAR-online-4gpu-prompts-k2)
...
OUTPUT_DIR="${OUTPUT_DIR:-Qwen2-0.5B-DAR-online-4gpu-prompts-k2}"
