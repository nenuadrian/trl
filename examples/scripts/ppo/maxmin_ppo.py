...
"""
MaxMin-RLHF PPO training script.

Implements Algorithm 1 from "MaxMin-RLHF: Alignment with Diverse Human Preferences"
(Chakraborty et al., ICML 2024). Requires pre-trained reward models (one per user
subpopulation), which can be obtained via the EM algorithm (em_reward_learning.py).

Single GPU example (2 reward models):
python examples/scripts/ppo/maxmin_ppo.py \
    --dataset_name trl-internal-testing/descriptiveness-sentiment-trl-style \
    --dataset_train_split descriptiveness \
    --learning_rate 3e-6 \
    --output_dir maxmin-ppo-pythia-1b \
    ...
    --reward_model_paths EleutherAI/pythia-1b-deduped EleutherAI/pythia-1b-deduped \
    --maxmin_strategy min \
