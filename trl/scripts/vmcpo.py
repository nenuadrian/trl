...
def main(script_args, training_args, model_args, dataset_args):
    ...
    # Initialize the VMCPO trainer
    trainer = VMCPOTrainer(
        model,
        ref_model,
        args=training_args,
...
def make_parser(subparsers: argparse._SubParsersAction | None = None):
    dataclass_types = (ScriptArguments, VMCPOConfig, ModelConfig, DatasetMixtureConfig)
    if subparsers is not None:
        parser = subparsers.add_parser(
            "vmcpo",
            help="Run the VMCPO training script",
