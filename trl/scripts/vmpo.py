...
@dataclass
class VMPOScriptArguments(ScriptArguments):
    """
    Script arguments for VMPO training.
...
def make_parser(subparsers: argparse._SubParsersAction | None = None):
    dataclass_types = (VMPOScriptArguments, VMPOConfig, ModelConfig, DatasetMixtureConfig)
    if subparsers is not None:
        parser = subparsers.add_parser("vmpo", help="Run the VMPO training script", dataclass_types=dataclass_types)
    else:
